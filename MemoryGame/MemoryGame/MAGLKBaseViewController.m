...
@property (nonatomic, strong) MATouchHandler *touchHandler;
...
{
    [_touchHandler touchesBegan:touches];
}

- (void)touchesMoved:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    [_touchHandler touchesMoved:touches];
}

- (void)touchesCancelled:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    [_touchHandler touchesCancelled:touches];
}

- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    [_touchHandler touchesEnded:touches];
}

- (void)setupControllers {}

- (void)_base_setupTouchHandler
{
    if (!_touchHandler) {
        _touchHandler = [[MATouchHandler alloc] initWithView:self.view];
