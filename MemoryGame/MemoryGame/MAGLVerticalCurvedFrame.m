...
- (void)setupBuffer
{
    ...
    NSString *modelString = circularPositionsTexelsNormalsFaces_vertical(self.maxLength, self.radius, self.sectionAngle, self.layerIndex, segments, [self.atlasData atlasSize], [self.spriteData originalSize],
